...
recommendationURL = f'https://api.themoviedb.org/3/movie/{id}/recommendations?api_key=3d8f29ed921ca581c56e31c9754cd386&language=en-US&page=1'
        ...
        if results[result_index] > 0.5:
            if tag == "recommendations":
                ...
                if n> 5:
                    n = 5
                for i in range(n):
                    s+= f"{i+1}. {data['results'][i]['original_title']}\n"
